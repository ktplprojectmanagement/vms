...
<tr class="tannumber_edit1"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['tan']) && $edit_user_details1['0']['tan'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
<td  style="color:green"><label for="contactName">Edit TAN number</label><br><lable style="color:green">(Note 1 : TAN number should contain capital letters only.)</lable><br><lable>(Note 2 : Only jpg,jpeg,pdf,png,docx files are allowed)</lable></td>
...
<?php if(isset($edit_user_details1['0']['tan_proof']) && $edit_user_details1['0']['tan_proof'] != '') { ?>
<a href="<?php echo base_url(); ?>proof/tan/<?php if(isset($edit_user_details1['0']['tan_proof'])) { echo $edit_user_details1['0']['tan_proof']; } ?>" target="_new"><input type="button"  class="btn btn-info" value="Open File" id="tan_gst_prf"></a>
<input type="button" value="Delete" class="btn btn-info del_attach" title="tan_proof">
<?php }
else
{ ?>
<div  id="show_capable1"><span style="cursor: pointer;"><lable style='color: rgb(2, 183, 195);'><input type="button" id="tan_proof0" class="btn btn-info" value="Upload Document"></lable></span><input type="file" name="tan_proof" id="tan_proof" class="file_change" style="margin-top: -19px;
opacity: 0;"></div>
<a href="" target="_blank" class="linkpan_proof"><lable id='tan_proof1' style="width: 53px;"></lable></a><lable id='tan_proof11' style="cursor:pointer;display: none"><input type="button" value="Delete" class="btn btn-info cancel_upload" id='tan_proof-1'>
</lable>
<?php } ?>
             ...
             <input type="button" class="btn btn-info" value="Back" id="back_tab_3"> 
                       ...
                       <table  class="table" style="margin-top: 10px">
                            ...
                            <tr> 
                                ...
                                <td><input type="text" style="width: 408px;" id="bank_name" name="bank_name"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['bank_name'])) { echo $edit_user_details['0']['bank_name']; }?>" disabled/></td>
                                <td><button type="button" id="bankname_edit" class="btn btn-default get_field">Edit</button><button type="button" id="close_bankname" class="btn btn-default close_field" style="display: none">Close</button></td>
                            </tr>
                            ...
                            <td style="color:green"><label for="contactName">Edit Bank Name</label></td>
                                        <td><input type="text" style="width: 408px;" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['bank_name']) && $edit_user_details1['0']['bank_name'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="bankname_edit ex_validate" name="bankname_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['bank_name'])) { echo $edit_user_details1['0']['bank_name']; }?>" maxlength="40" required/>
                            ...
                            <tr> 
                                ...
                                <td><input type="text" style="width: 408px;" id="bank_addr" name="bank_addr"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['bank_addr'])) { echo $edit_user_details['0']['bank_addr']; }?>" disabled/></td>
                                <td><button type="button" id="bankaddr_edit" class="btn btn-default get_field">Edit</button><button type="button" id="close_bankaddr" class="btn btn-default close_field" style="display: none">Close</button></td>
                            </tr>
                            ...
                            <td style="color:green"><label for="contactName">Edit Bank Address</label></td>
                                        <td><input type="text" style="width: 408px;" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['bank_addr']) && $edit_user_details1['0']['bank_addr'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="bankaddr_edit ex_validate" name="bankaddr_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['bank_addr'])) { echo $edit_user_details1['0']['bank_addr']; }?>" maxlength="40" required/>
                            ...
                            <tr> 
                                ...
                                <td><input type="text" style="width: 408px;" id="bank_account" name="bank_account"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['acc_number'])) { echo $edit_user_details['0']['acc_number']; }?>" disabled/></td>
                                <td><button type="button" id="bankaccount_edit" class="btn btn-default get_field">Edit</button><button type="button" id="close_bankaccount" class="btn btn-default close_field" style="display: none">Close</button></td>
                            </tr>
                            <tr class="bankaccount_edit1"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['acc_number']) && $edit_user_details1['0']['acc_number'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                            <td style="color:green"><label for="contactName">Edit Bank Account Number</label></td>
                                        <td><input type="text" style="width: 408px;" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['acc_number']) && $edit_user_details1['0']['acc_number'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="bankaccount_edit ex_validate" name="bankaccount_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['acc_number'])) { echo $edit_user_details1['0']['acc_number']; }?>" maxlength="40" required/>
                                        <button type="button" id="save_bankaccount" class="btn btn-default savedetails save_bankaccount">Save</button>
                                    </td>                         
                            </tr>
                            
                            <tr> 
                                <td><label for="contactName">Bank IFSC Code</label></td>
                                <td><input type="text" style="width: 408px;" id="bank_ifsc" name="bank_ifsc"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['ifsc_code'])) { echo $edit_user_details['0']['ifsc_code']; }?>" disabled/></td>
                                <td><button type="button" id="bankifsc_edit" class="btn btn-default get_field">Edit</button><button type="button" id="close_bankifsc" class="btn btn-default close_field" style="display: none">Close</button></td>
                            </tr>
                             <tr class="bankifsc_edit1"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ifsc_code']) && $edit_user_details1['0']['ifsc_code'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                            <td style="color:green"><label for="contactName">Edit Bank IFSC Code</label></td>
                                        <td><input type="text" style="width: 408px;" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ifsc_code']) && $edit_user_details1['0']['ifsc_code'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="bankifsc_edit ex_validate" name="bankifsc_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['ifsc_code'])) { echo $edit_user_details1['0']['ifsc_code']; }?>" maxlength="40" required/>
                                        <button type="button" id="save_bankifsc" class="btn btn-default savedetails save_bankifsc">Save</button>
                                    </td>                         
                            </tr>
                            
                            <tr> 
                                <td><label for="contactName">CIN Number</label></td>
                                <td><input type="text" style="width: 408px;" id="bank_cin" name="bank_cin"  value="<?php if(isset($edit_user_details) && count($edit_user_details)>0 && isset($edit_user_details['0']['cin_number'])) { echo $edit_user_details['0']['cin_number']; }?>" disabled/></td>
                                <td><button type="button" id="bankcin_edit" class="btn btn-default get_field">Edit</button><button type="button" id="close_bankcin" class="btn btn-default close_field" style="display: none">Close</button></td>
                            </tr>
                            <tr class="bankcin_edit1"  <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['cin_number']) && $edit_user_details1['0']['cin_number'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>>
                            <td style="color:green"><label for="contactName">Edit Bank IFSC Code</label></td>
                                        <td><input type="text" style="width: 408px;" <?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['cin_number']) && $edit_user_details1['0']['cin_number'] != '') { ?>
                                        style="display: ''"<?php } else { ?>style="display: none"<?php } ?>  class="bankcin_edit ex_validate" name="bankcin_edit"  value="<?php if(isset($edit_user_details1) && count($edit_user_details1)>0 && isset($edit_user_details1['0']['cin_number'])) { echo $edit_user_details1['0']['cin_number']; }?>" maxlength="40" required/>
...
else if(sep[1] == 'tannumber')
  {
          ...
          {          
            ...
            else
            {
              ...
              else if($("#tan_proof").val() == '' && $("#tan_gst_prf").val() === undefined)
              {
                 $(".tannumber_edit").css('border-color','red'); 
                 error = "Please upload supporting document for TAN";
              }
              else if(ext1[1] != 'pdf' && ext1[1] != 'jpg' && ext1[1] != 'png' && ext1[1] != 'jpeg' && ext1[1] != 'docx')
                {
                  $("#tan_number").css('border-color','red');            
                  error = "Only jpg,jpeg,pdf,png,docx files are allowed.";        
                }
              else
              {
                ...
                form_data.append("tannumber",$(".tannumber_edit").val());
                  //alert("hgjhg");
                  if($('#tan_proof').length==0)
                  {
                  form_data.append("tan_gst_prf",'0');
                  }
                  else if($('#tan_proof').length>0) 
                  {
                   form_data.append("tan_gst_prf",'1');
                  form_data.append("tan_proof",$('#tan_proof')[0].files[0]);
                  }        
              }
            }
  }
