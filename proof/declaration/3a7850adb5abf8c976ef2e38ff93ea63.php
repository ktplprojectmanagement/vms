...
<div class="col-lg-12 col-md-12 col-sm-8 col-xs-9 bhoechie-tab-container" style="width: 138%;margin-left: -59px;">
            ...
            <div class="col-lg-12 col-md-9 col-sm-9 col-xs-9 bhoechie-tab" style="font-size: 17px;height: 47px;padding-top: 11px;border-bottom: 1px solid rgb(222, 222, 222);color: rgb(51, 122, 199);">
            Primary Details : 
            </div>
            <div class="col-lg-12 col-md-9 col-sm-9 col-xs-9 bhoechie-tab">
                <!-- flight section -->
                <div class="bhoechie-tab-content active"  id="next1">
                                        <table  class="table">
                                        <!-- <tr>
             ...
             <!--  <input type="button" value="Next" class="shownext" id="next2"> -->
                ...
                <!-- train section -->
                <div class="col-lg-12 col-md-9 col-sm-9 col-xs-9 bhoechie-tab" style="font-size: 17px;height: 47px;padding-top: 11px;border-bottom: 1px solid rgb(222, 222, 222);color: rgb(51, 122, 199);margin-bottom: 15px;">
            Other Details : 
            </div>
                <div class="bhoechie-tab-content active" id="next2">
                                 <table  class="table">                                   
                                    <tr>
                                ...
                                <tr>
                                 ...
                                 <tr class="countrykey_edit" style="display: none">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text"  class="City_edit city_validation" style="display: none"  name="City_edit"  value="" required/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text"  class="district_edit district_validation" style="display: none"  name="district_edit"  value="" required/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text"  class="postalcode_edit postal_code_validate" style="display: none"  name="postalcode_edit"  value="" required/></td>
                                    </tr>
                                    <tr>                                        
                                        ...
                                        <td><input type="text"  class="telephone1_edit tele_number" style="display: none"  name="telephone1_edit"  value="" required/></td>
                                    </tr>
                                     <tr>
                                        ...
                                        <td><input type="text"  class="telephone2_edit tele_number" style="display: none"  name="telephone2_edit"  value="" required/></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input type="text"  class="faxnumber_edit fax_validate" style="display: none"  name="faxnumber_edit"  value="" required/></td>
                                    </tr>
                                     <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td><input type="text"  class="pannumber_edit pan_validate" name="pannumber_edit" style="display: none"  value="" required/><div><span style="cursor: pointer;"><lable style='color: rgb(2, 183, 195);'><u>Upload Document</u> </lable></span><input type="file" name="pan_proof" id="pan_proof" style="margin-top: -19px;
opacity: 0;"></div></td>
                                    </tr>
                                </table> 
            ...
            VAT Details : 
                ...
                <!-- hotel search -->
                <div class="bhoechie-tab-content active" id="next3">
                         <table  class="table">
                            <!--  <tr>
...
<div class="col-lg-12 col-md-9 col-sm-9 col-xs-9 bhoechie-tab" style="font-size: 17px;height: 47px;padding-top: 11px;border-bottom: 1px solid rgb(222, 222, 222);color: rgb(51, 122, 199);margin-bottom: 15px;">
            GST Details : 
                ...
                <div class="bhoechie-tab-content active"  id="next4">
                       <table  class="table">
                            <tr>
                                <td><label for="contactName">Applicable For GST <span class="required">*</span></label></td>
                                ...
                                <div id="show_capable1" style="display: none"><span style="cursor: pointer;"><lable style='color: rgb(2, 183, 195);'><u>Upload Declaration</u> </lable></span><input type="file" name="gst_declr" id="gst_declr" style="margin-top: -19px;
opacity: 0;"></div>
                                </td>
                            </tr>
                            <tr>
...
opacity: 0;"></div></td>
                        ...
                        <input type="button" value="Save" id="vendor_data_update" style="float: right;margin-bottom: 10px;">
                </div>
